...
const truckPerformance = {
	...
	show: function(){
		this.exists ? map.setPaintProperty('truck-performance', 'line-opacity', 1.0) : this.addLayer();
	},

	hide: function() {
		this.exists ? map.setPaintProperty('truck-performance', 'line-opacity', 0.0) : '';
	},

	addLayer: function(){
		map.addSource("truck-pm", {
			"type": "vector",
			"url": "https://a.michaelruane.com/data/dvrpc-pff-truck.json"
		});
		map.addLayer({
