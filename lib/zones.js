...
$(document).ready(function(){
    ...
    $.ajax({
        type:'GET',
        url:'http://wololo.co/dvrpc-tim-viewer/api/zones.php?t=t&fn=7&f0=otraffic_car&f1=otraffic_transit_auto&f2=otraffic_transit_walk&f3=dtraffic_car&f4=dtraffic_transit_auto&f5=dtraffic_transit_walk&f6=itraffic_car',
        dataType:'JSON',
        data:{
        },
        beforeSend: function(){
