      ...
      `<h5>${e.features[0].properties.site_addr}</h5>
        <table style="width:100%">
          ...
          <tr>
            ...
            <td align="right">${e.features[0].properties.dwell_units}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="right">${e.features[0].properties.spaces_unit}</td>
          </tr>
        </table>
        <br/>
