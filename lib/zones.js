...
function Kalp() {
  var popdensityhack = $.getJSON(
    "https://wololo.co/dvrpc-tim-viewer/api/zones.php?t=a&fn=2&f0=taz_area&f1=population",
...
function getTransitAccess() {
  return _getAPI(
    "https://wololo.co/dvrpc-tim-viewer/api/zones.php?t=a&fn=1&f0=pct_qtrmi_transit",
    "pct_qtrmi_transit"
  );
}
function getNearbyEmp() {
  return _getAPI(
    "https://wololo.co/dvrpc-tim-viewer/api/zones.php?t=a&fn=1&f0=emp_1mi",
    "emp_1mi"
  );
}
function Sylph() {
...
function selectZone(no) {
  ...
  var results = $.post(
    "https://wololo.co/dvrpc-tim-viewer/api/zones.php",
    payload
  ).done(function (data) {
