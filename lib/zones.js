...
function selectZone(no) {
	...
	var payload = JSON.stringify({
		    "netobj": "zone",
		    "keys": {"no": no},
		    "netfields": ["name", "population","total_employment","households","vehpp","area_type","autos","ag_mining","arts_rec_food" ,"construction","eds_meds","fire","information","manufacturing","other_services","prof_services","public_admin","retail_trade","transport_wh_util","wholesale_trade"],
		    "datfields": {
